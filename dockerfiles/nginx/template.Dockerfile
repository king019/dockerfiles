...
#define APP_DEPS libpcre3 zlib1g libatomic-ops-dev libgd3
#define APP_BUILD_TOOLS build-essential git autoconf automake libtool wget tar libgd-dev libpcre3-dev zlib1g-dev unzip patch LINUX_HEADERS util-linux binutils
